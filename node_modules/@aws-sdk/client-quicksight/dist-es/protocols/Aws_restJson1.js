...
const se_AssetBundleImportJobRefreshScheduleOverrideParameters = (input, context) => {
    return take(input, {
        DataSetId: [],
        ScheduleId: [],
        StartAfterDateTime: (_) => _.getTime() / 1000,
    });
};
...
const se_TimeEqualityFilter = (input, context) => {
    return take(input, {
        ...
        RollingDate: _json,
        TimeGranularity: [],
        Value: (_) => _.getTime() / 1000,
    });
};
const se_TimeRangeDrillDownFilter = (input, context) => {
    return take(input, {
        Column: _json,
        RangeMaximum: (_) => _.getTime() / 1000,
        RangeMinimum: (_) => _.getTime() / 1000,
        TimeGranularity: [],
    });
};
